...
import de.schulscheduler.beans.BaseChangeListener;
...
public abstract class BaseGraphicTableCell<S, T> extends TableCell<S, T> {
     ...
     * fokussiert werden.
     */
    private final ChangeListener<Boolean> onContentFocusListener = new ChangeListener<Boolean>() {
     ...
     */
    private final BaseChangeListener<TableView<S>> tableViewListener = new BaseChangeListener<TableView<S>>() {
     ...
     * mit {@link #updateFocus()} die entsprechenden Member aus {@link TableCell} nach, um reagieren zu können, wenn die
     * Zelle mittels des {@link TableViewFocusModel} fokussiert wird.
     */
    private final InvalidationListener focusedCellListener = new InvalidationListener() {
